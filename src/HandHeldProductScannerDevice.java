...
public class HandHeldProductScannerDevice {
...
//	JButton btn_sbmt;
	...
	public HandHeldProductScannerDevice() {
		HandHeldProductScannerDevice();
	}
	
	public void HandHeldProductScannerDevice() {
...
//		frame.setResizable(false);
		...
		btn_cancel.setBounds(170, 45, 60, 35);
...
//		name_txt.setBorder(null);
		...
		name_txt.setBounds(100, 90, 170, 40);
		name_txt.setBackground(Color.green);
		panel.add(name_txt);
		...
		pwd_txt.setBounds(100, 140, 170, 40);
		panel.add(pwd_txt);
		...
		btn_cancel = new JButton("ESC");
		btn_cancel.setSize(55, 35);
		btn_cancel.setBounds(170, 190, 60, 35);
		panel.add(btn_cancel);

	}
	
	public static void main(String[] args) {
		new HandHeldProductScannerDevice();
	}
